...
/**
 * Fork from: https://github.com/cantonios/vscode-project-templates/
...
export async function copyDir(src: string, dest: string) {
    ...
    // synchronously create destination if it doesn't exists to ensure 
 ...
 * @returns 
 */
export function mkdirSync(dest: string, mode: string | number | null | undefined = undefined) : boolean {
    // check if exists
    if (fs.existsSync(dest)) {
